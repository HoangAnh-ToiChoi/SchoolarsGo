    ...
    <section className="relative flex min-h-[90vh] items-center justify-center px-4 pt-20 z-10">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <h1 className="mb-6 text-4xl font-bold leading-tight tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
          <span className="text-gray-900 dark:text-white">ScholarsGo — </span>
        ...
        {/* Subheading */}
        <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-600 dark:text-white/60 sm:text-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <a
            href="#features"
            className="flex items-center gap-2 rounded-xl border border-gray-300 dark:border-white/20 bg-gray-100 dark:bg-white/5 px-8 py-4 text-lg font-medium text-gray-700 dark:text-white backdrop-blur-sm transition-all hover:border-gray-400 dark:hover:border-white/40 hover:bg-gray-200 dark:hover:bg-white/10"
          >
            Tìm hiểu thêm
          </a>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 gap-8 sm:grid-cols-4">
          {[
            ...
            <div key={stat.label} className="text-center">
              ...
              <div className="mt-1 text-sm text-gray-500 dark:text-white/50">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
