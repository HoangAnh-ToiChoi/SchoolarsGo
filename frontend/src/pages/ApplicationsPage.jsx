        ...
        {isLoading ? (
          ...
          <AnimatedList className="space-y-6">
            ...
            return (
              ...
              <div className="overflow-hidden bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-[0_0_30px_rgba(168,85,247,0.05)] transition-all hover:bg-white/10 hover:border-purple-500/30">
