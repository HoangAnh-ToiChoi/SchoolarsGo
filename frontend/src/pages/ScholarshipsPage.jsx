      ...
      {showFilters && (
        <div className="card card-body mb-6 animate-slide-down">
          ...
          <div className="mt-5 flex flex-wrap justify-end gap-3 border-t border-slate-100 pt-4">
            <Button variant="ghost" onClick={handleReset}>Xoa bo loc</Button>
            <Button onClick={() => setShowFilters(false)} variant="secondary">An bo loc</Button>
          </div>
        </div>
      )}
